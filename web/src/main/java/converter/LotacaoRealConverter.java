 ...
 */
@FacesConverter("lotacaoRealConverter")
public class LotacaoRealConverter implements Converter {

    private Repository<? extends AbstractEntity> repositorio;
    private RepositoryFactory factory;

    public LotacaoRealConverter() throws NamingException {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (repositorio == null) {
            repositorio = factory.getRepository(LotacaoReal.class);
        }
